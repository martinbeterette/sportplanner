...
if (isset($_POST['modificacion'])) {
    ...
    $sql = "UPDATE
                    estado_zona
                SET 
                    descripcion_estado_zona = '$descripcion'
                WHERE
                    id_estado_zona = $id";
...
<head>
    ...
    <title>Modificacion Estado Zona</title>
...
<body>
    ...
    <h1 style="text-align: center; margin-top: 25px; margin-bottom: 20px;">Modulo Modificacion de Estado Zona</h1>

    <form action="<?php echo $_SERVER['PHP_SELF'] . '?id_estado_zona=' . $id; ?>" method="post" onsubmit="return confirmModification();">
