...
$sql = "SELECT id_estado_zona, descripcion_estado_zona, estado	FROM estado_zona WHERE estado IN(1)";
...
<body>
	...
	<div class="container">
		<h1 style="text-align: center; margin-top: 25px; margin-bottom: 20px;">Modulo de Estado Zona</h1>
		...
		<table>
			...
			<tbody>
				...
				<?php foreach ($registros as $reg) :
					...
					$id  = $reg['id_estado_zona'];
					$descripcion = $reg['descripcion_estado_zona'];

					$modificar = "<a href='tablaEstadoZona_modificacion.php?id_estado_zona=$id'>
				...
				<tr>
					<td colspan="8" class="alta">
						<a href="tablaEstadoZona_alta.php">
	...
	<script>
		function confirmDelete(id) {
			...
			if (respuesta) {
				...
				window.location.href = "tablaEstadoZona_baja.php?id_estado_zona=" + id;
			}
		}
	</script>
</body>
