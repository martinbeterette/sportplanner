...
<body>
    ...
    <h1 style="text-align: center; margin-top: 25px; margin-bottom: 20px;">Modulo Alta de Estado Zona</h1>

    <form action="tablaEstadoZona_aplicar_alta.php" method="post">
