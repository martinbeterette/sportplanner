...
<body>
    ...
    <h1 style="text-align: center; margin-top: 25px; margin-bottom: 20px;">Modulo Modificacion de Perfil</h1>

    <form action="<?php echo $_SERVER['PHP_SELF'] . '?id_perfil=' . $id; ?>" method="post" onsubmit="return confirmModification();">
