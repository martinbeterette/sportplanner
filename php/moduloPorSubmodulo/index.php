<?php 
    ...
    $registros_cancha = $conexion->query("SELECT * FROM zona WHERE rela_sucursal = $id_sucursal");
...
<script>
    ...
    $('#reservar').on('click',function() {
        ...
        window.location.href = `includes/reservar.php?id_persona=${id_persona}&cancha=${id_zona}&fecha_reserva=${fecha_reserva}`;
    });
</script>
