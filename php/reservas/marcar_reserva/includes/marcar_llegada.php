...
function actualizarAsistencia($id_sucursal, $id_reserva, $pagina_actual, $metodo_pago) {
    ...
    if ($stmt = $conexion->prepare($sql)) {
        ...
        $stmt->bind_param("ssi", $hora_actual, $metodo_pago,$id_reserva);
