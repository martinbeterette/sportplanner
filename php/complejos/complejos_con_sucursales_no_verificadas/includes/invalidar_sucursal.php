<?php  
	...
	$sql = "
		UPDATE sucursal SET verificado = 'no verificado' WHERE id_sucursal = $id_sucursal;
	";
	...
	if($conexion->query($sql)) {
		...
		$sql = "INSERT into auditoria_verificado_sucursal(accion,estado_anterior, estado_posterior, tiempo_accion, rela_usuario) VALUES('Invalidacion', '$json_anterior', '$json_posterior', CURTIME(), $id_usuario)";
		if($conexion->query($sql)) {
