...
@section('content')
    <h2 class="text-center my-4">Tabla de Deportes</h2>
    {{-- Filtros --}}
    <div class="row mb-4">
        <div class="col-md-6">
    ...
    <div class="mb-3 text-end">
        <a href="{{ route('deporte.create') }}" class="btn btn-primary">
            <i class="fas fa-plus me-2"></i> Crear deporte
        </a>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ¿Estás seguro de que querés eliminar este deporte? Esta acción no se puede deshacer.
          </div>
...
@section('extra_js')
    <script>
        ...
        let page = 1;
        let urlDeEliminacion = '/tablas-maestras/deporte/eliminar/';
        let urlDeModificacion  = '/tablas-maestras/deporte/modificar/';
    </script>
