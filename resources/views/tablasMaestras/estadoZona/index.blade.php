...
@section('content')
    <h2 class="text-center my-4">{{ $titulo }}</h2>
    ...
    <div class="mb-3 text-end">
        <a href="{{ route("$table.create") }}" class="btn btn-primary">
            <i class="fas fa-plus me-2"></i> Crear {{ ucfirst(str_replace('_', ' ', $table)) }}
        </a>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ¿Estás seguro de que querés eliminar este {{ str_replace('_', ' ', $table) }}? Esta acción no se puede deshacer.
          </div>
...
@section('extra_js')
    <script>
        let url = '/api/estado-zona';
        let data = { registros_por_pagina: 5 };
        let campos = ['id', 'descripcion'];
        let page = 1;
        let urlDeEliminacion    = '/tablas-maestras/estado-zona/eliminar/';
        let urlDeModificacion   = '/tablas-maestras/estado-zona/modificar/';
    </script>
