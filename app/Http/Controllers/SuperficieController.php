...
{
    private $model = Superficie::class;
    private $table = "superficie";
    /**
    ...
    {
        return view('tablasMaestras.superficie.crearSuperficie');
    }
    ...
    public function edit($id) 
    {
        ...
        return view('tablasMaestras.superficie.modificarSuperficie', $data);
    }
